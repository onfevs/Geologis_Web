  ...
  return (
    <div className="relative bg-black text-white selection:bg-[#D4AF37] selection:text-black antialiased overflow-x-hidden">
      ...
      <main>
        ...
        <RevealSection id="dominios" bgColor="bg-black"><DomainsTabbedSection /></RevealSection>

        {/* 4. Proof of Work (Trust) */}
        <RevealSection id="proyectos" bgColor="bg-black"><ProjectsSection /></RevealSection>
        <RevealSection id="media" bgColor="bg-zinc-950"><YoutubeSection /></RevealSection>

        {/* 5. Social Proof (Validation) */}
        <RevealSection id="testimonios" bgColor="bg-black"><ReviewsSection /></RevealSection>

        {/* 6. Objections & Logistics (Friction Removal) */}
        <RevealSection id="faq" bgColor="bg-zinc-950"><FAQSection /></RevealSection>
        <RevealSection id="ubicacion" bgColor="bg-black"><MapSection /></RevealSection>

        {/* 7. Call To Action (Conversion) */}
        <RevealSection id="contacto" bgColor="bg-zinc-950"><ContactSection /></RevealSection>
      </main>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 items-start">
            <div className="space-y-10">
              <h2 className="text-4xl font-title text-white tracking-tighter italic">OnfeVS <span className="text-[#D4AF37]">Geologis</span></h2>
            ...
            <div className="space-y-10">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-[200px]">
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/jorgevallejo/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-[#0077B5] hover:border-[#0077B5] transition-all group rounded-xl">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/onfevs/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-gradient-to-br hover:from-[#E1306C] hover:to-[#833AB4] hover:border-[#E1306C] transition-all group rounded-xl">
                  <svg className="w-5 h-5 text-zinc-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.266.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.848 0-3.204.012-3.584.07-4.849.149-3.225 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
                </a>
                {/* YouTube */}
                <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-red-600 hover:border-red-600 transition-all group rounded-xl">
